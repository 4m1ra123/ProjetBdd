...
class Client(models.Model):
    ...
    password_client = models.CharField(db_column='Password_client', max_length=50)  # Field name made lowercase.
...
class Events(models.Model):
    ...
    id_creneau = models.ForeignKey(Creneau, models.DO_NOTHING, db_column='Id_creneau', unique=True)  # Field name made lowercase.
